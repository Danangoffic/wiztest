...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2021 at 10:40 PM
...
(1, 1, 1, 1, 1, 1100000, '07:00:00', '12:00:00', 1, 1, '2021-01-01 00:00:00', NULL),
(2, 2, 1, 1, 1, 875000, '07:00:00', '22:00:00', 1, 1, '2021-01-01 00:00:00', NULL),
(3, 2, 2, 1, 1, 125000, '07:00:00', '22:00:00', 1, 1, '2021-01-01 00:00:00', NULL),
(4, 2, 3, 1, 1, 250000, '07:00:00', '22:00:00', 1, 1, '2021-01-01 00:00:00', NULL),
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `id_status_peserta_fk` FOREIGN KEY (`status_peserta`) REFERENCES `status_hasil` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
