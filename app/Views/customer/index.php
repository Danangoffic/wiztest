...
<div class="container-fluid img-index">
    <div class="row">
                ...
                <div class="container text-primary">
                    <div class="row">
                        <div class="col-md-4 text-center">
                            <h2 class="">Jam Operasional</h2>
                        </div>
                        <div class="col-md-4 text-center">
                            <h4>Week Days</h4>
                            <h6>(07.00 - 22.00)</h6>
                            <h6>Tidak Termasuk Libur nasional</h6>
                        </div>
                        <div class="col-md-4 text-center">
                            <h4>Week End</h4>
                            <h6>(07.00 - 22.00)</h6>
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary radius-30" type="button" onclick="return getRescheduleNoRegistration()">Cari</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary radius-30" data-dismiss="modal">Close</button>
            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary radius-30" type="button" onclick="return getCheckNoRegistration()">Cari</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content radius-30">
            ...
            <div class="" id="page1">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama lengkap" aria-placeholder="Masukkan Nama lengkap" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nik" class="col-md-3">Nomor KTP/NIK</label>
                        <div class="col-md-9">
                            <input type="text" name="nik" id="nik" class="form-control" placeholder="Masukkan Nomor KTP / NIK" aria-placeholder="Masukkan Nomor KTP / NIK" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="phone" class="col-md-3">Nomor WhatsApp</label>
                        <div class="col-md-9"><input type="number" inputmode="tel" placeholder="Masukkan Nomor Whatsapp" aria-placeholder="Masukkan Nomor Whatsapp" name="phone" id="phone" placeholder="" class="form-control"></div>
                    </div>
                    <div class="form-group row">
                        <label for="confirmphone" class="col-md-3">Konfirmasi Nomor WhatsApp</label>
                        <div class="col-md-9"><input type="number" inputmode="tel" name="confirmphone" placeholder="Masukkan Sesuai Nomor Whatsapp" placeholder="Masukkan Sesuai Nomor Whatsapp" id="confirmphone" class="form-control"></div>
                    </div>
                    <div class="form-group row">
                        <label for="email" class="col-md-3">Email</label>
                        <div class="col-md-9"><input type="email" inputmode="email" placeholder="Masukkan email" name="email" id="email" class="form-control"></div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9"><input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control" placeholder="Masukkan tempat lahir"></div>
                    </div>
                    <div class="form-group row">
                        <label for="tgl_lahir" class="col-md-3">Tanggal Lahir</label>
                        <div class="col-md-9"><input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control" placeholder="Masukkan tanggal lahir"></div>
                    </div>
                    <div class="form-group row">
                        <label for="alamat" class="col-md-3">Alamat Lengkap</label>
                        <div class="col-md-9">
                            <textarea name="alamat" id="alamat" cols="" rows="3" class="form-control" placeholder="Masukkan alamat lengkap"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="marketing" class="col-md-3">Marketing</label>
                        <div class="col-md-9">
                            <select name="marketing" id="marketing" class="form-control" aria-readonly="true" readonly disabled aria-disabled="true">
                                <?php
                ...
                <div class="modal-footer rounded-bottom">
                    <button type="button" class="btn btn-secondary radius-30" data-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-primary radius-30" onclick="nextForm()">Lanjut</button>
                </div>
            </div>
            ...
            <div class="" id="page2">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary radius-30" id="backForm" onclick="backForm()">Kembali</button>
                    <button type="button" class="btn btn-primary radius-30" id="registrasi">Registrasi</button>
                </div>
            </div>
...
<script>
    ...
    function getMenu() {
        $.get('<?= base_url('menu'); ?>').then(e => {
            ...
            menus += title_menu;
            $.each(e, (i, v) => {
                menus += `<div class="col-lg-4 mt-2">
                    <div class="card my-5 radius-30" onclick="modalRegistrasi(${v.id_jenis_test})">
                        <div class="card-body bg-light radius-30">
                            <img src="<?= base_url('assets'); ?>/${v.img_url}" style="margin-top:-25%" height="100" width="100" class="card-img-top" alt="${v.keterangan}">
                            <h5 class="card-title text-center text-primary" style="margin-top: 1.25em">${v.keterangan}</h5>
                            <a href="#" class="btn btn-primary btn-block radius-30"><strong>CHECK OUT</strong></a>
                        </div>
                    </div>
                </div>`;
            });
