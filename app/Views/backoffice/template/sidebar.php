            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item <?= $menu_open; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('backoffice/registrasi/registrasi'); ?>" class="nav-link <?= ($page == 'registrasi') ? 'active' : ''; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Registrasi</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('backoffice/registrasi/registrasi_overkuota'); ?>" class="nav-link <?= ($page == 'registrasi_overkuota') ? 'active' : ''; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Registrasi Over Kuota</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('backoffice/registrasi/instansi'); ?>" class="nav-link <?= ($page == 'instansi') ? 'active' : ''; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Instansi</p>
                            </a>
                        </li>
