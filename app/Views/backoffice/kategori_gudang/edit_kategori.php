                ...
                <div class="col-md-6">
                    <form action="<?= base_url('backoffice/' . $page . '/update/' . $id); ?>" method="post">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <?= csrf_field(); ?>
                                <input type="hidden" name="id_kategori" value="<?= $data['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-3" for="nama_kategori">Nama Kategori</label>
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" value="<?= (old('nama_kategori')) ? old('nama_kategori') : $data['nama_kategori']; ?>" required autocomplete="off" placeholder="Nama Kategori">
