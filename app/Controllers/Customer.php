...
class Customer extends ResourceController
{
    ...
    protected function getOrderId($type_test, $jenis_pemeriksaan, $tgl_kunjungan, $jenis_layanan, $jam_kunjungan)
    {
        $awal = '';
        switch ($type_test) {
            case '1':
    ...
    protected function getUrutan($type_test, $tgl_kunjungan, $jenis_pemeriksaan, $jenis_layanan)
    {
